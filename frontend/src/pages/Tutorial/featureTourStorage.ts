// localStorage helpers for the feature tour "Don't show again" preference.
// Follows the ThemeContext named-constant + try/catch convention to avoid throws in private-browsing mode.
