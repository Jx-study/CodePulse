    ...
    "questions": [
        # 【Basic 基礎】 800-950
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "options": [
                        {"id": "A", "text": "Because the algorithm produces memory fragments like bubbles"},
                        {"id": "B", "text": "Because larger (or smaller) elements gradually 'bubble up' to the top (end) of the array like air bubbles in water"},
                        {"id": "C", "text": "The inventor's name was Bubble"},
                        {"id": "D", "text": "Because its time complexity grows like a bubble"},
                    ],
        ...
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "explanation": "Bubble Sort is stable. The condition `if arr[j] > arr[j + 1]` ensures swaps only happen when the left element is strictly greater, so equal elements are never swapped, preserving their relative order.",
                },
            },
        },
        {
        ...
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "options": [
                        {"id": "A", "text": "Yes, to confirm it is still the maximum"},
                        {"id": "B", "text": "Yes, the loop design cannot skip specific elements"},
                        {"id": "C", "text": "No, because each round places the current maximum in its correct position, shrinking the comparison range"},
                        {"id": "D", "text": "No, because 8 was already at the end"},
                    ],
        ...
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    "title": "For an array of length n, how many times at most does the outer loop `for i in range(n - 1)` execute in the simplified Bubble Sort?",
                    "options": [
                        {"id": "A", "text": "n times"},
                        {"id": "B", "text": "n - 1 times"},
                        {"id": "C", "text": "n / 2 times"},
        ...
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "explanation": "This is the most common early-termination optimization for Bubble Sort. If an entire round passes without any swap, it means all adjacent elements are already in order — the array is sorted — and we can break immediately to skip unnecessary comparisons.",
                },
            },
        },
        {
        ...
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "explanation": "Using >= causes equal adjacent elements to be swapped too. For example [2a, 2b] (same value, a originally before b), using >= swaps them, breaking the original relative order. Stability in Bubble Sort relies on swapping only when strictly greater (>); changing to >= destroys stability.",
                },
            },
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "options": [
                        ...
                        {"id": "opt4", "text": "Space complexity is O(n) because it needs an extra array for swap storage"},
                    ],
                    "explanation": "Bubble Sort uses nested loops, requiring O(n²) time on average and in the worst case (e.g., reverse-sorted). However, since it sorts in-place using only a few extra variables, space complexity is O(1). opt4 is incorrect.",
                },
            },
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "explanation": "A fully reversed array is the worst case. Every adjacent pair needs to be swapped. The formula is n(n-1)/2, so for length 5: 5×4/2 = 10 swaps.",
                },
            },
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "options": [
                        ...
                        {"id": "C", "text": "To avoid index out of bounds"},
                        {"id": "D", "text": "It's just a coding convention; performance is the same either way"},
                    ],
        ...
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    ...
                    "explanation": "Bubble Sort is actually stable, so opt3 is incorrect. It's avoided primarily because O(n²) is too slow (opt1), and constant overhead from adjacent swaps is high (opt2). In practice we use built-in O(n log n) algorithms (opt4). Bubble Sort is mainly for educational purposes.",
                },
            },
        },
        {
        ...
        },
        {
            ...
            "translations": {
                ...
                "en": {
                    "title": "Given the already-sorted array collection = [1, 2], calling the optimized bubble_sort([1, 2]) below. Write the sequence of line numbers executed (space-separated).",
                    "options": [],
                    "explanation": "Length 2 (L2). Enter outer loop round 0 (L3), init False (L4), range 1 (L5). Enter inner loop (L6), compare 1 > 2 is False (L7). Inner loop ends, back to for (L6). Check early exit: not False (L10). Trigger break (L11). Return result (L12).",
                },
            },
        },
    ],
